...
include-in-header:
  - text: |
      <link rel="stylesheet" href="project-card-overrides.css?v=guide-preview-2">
...
```{=html}
<img class="schism-still" src="projects/assets/game-design-sandbox/schism-thumbnail.svg" alt="Schism illustration with checkerboard walls, a red heart, and Kiki and Bouba together">
<img class="schism-background" src="projects/assets/game-design-sandbox/schism-thumbnail-background.svg" alt="" aria-hidden="true">
<img class="schism-hover" src="projects/assets/game-design-sandbox/schism-thumbnail-hover.gif" alt="" aria-hidden="true" loading="eager">
<button type="button" class="schism-preview-toggle" aria-pressed="false" aria-label="Play Kiki and Bouba jumping preview" hidden>Play preview</button>
<script src="projects/assets/cards/schism-thumbnail.js" defer></script>
```
