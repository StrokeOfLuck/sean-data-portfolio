...
<canvas class="lyon-routes" role="img" aria-label="27 cycling rides in Lyon, reconstructed chronologically from GPS recordings"></canvas>
...
<script src="projects/assets/lyon/thumbnail.js?v=1" defer></script>
```
