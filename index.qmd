...
![](projects/assets/cards/congressional-stock-network.svg){fig-alt="Miniature recreation of the congressional stock trading network interface"}
:::
::: {.project-card-body}
...
::: {.project-card .featured-project-card}
::: {.project-card-art .project-card-image}
![](projects/assets/cards/stock-disclosures.svg){fig-alt="Miniature recreation of a featured congressional periodic transaction report and extracted transactions"}
:::
::: {.project-card-body}
::: {.project-card-heading}
...
![](https://drive.google.com/thumbnail?id=1kCgZ4PEYHndaUcQFrkFVmwpD9nxYZFCk&sz=w2000){fig-alt="TankieTube University of Amsterdam Digital Methods research poster"}
:::
::: {.project-card-body}
::: {.project-card-heading}
### TankieTube
...
::: {.project-card-art .project-card-image}
![](projects/assets/cards/all-we-are-solar-map.svg){fig-alt="Source-derived preview of installed All We Are solar sites in Uganda"}
:::
::: {.project-card-body}
::: {.project-card-heading}
...
::: {.project-card .compact-project-card}
::: {.project-card-art .project-card-image}
![](projects/assets/cards/lyon-cycling-map.svg){fig-alt="Diagram of the GoPro to GPS to interactive map workflow used for the Lyon cycling project"}
:::
::: {.project-card-body}
::: {.project-card-heading}
### Lyon Cycling Map
