...
resources:
  ...
  - projects/assets/cards/mobile-scroll-preview.js
---
...
```{=html}
<img class="lyon-satellite" src="projects/assets/lyon/satellite.jpg" alt="Satellite imagery of Lyon, France" loading="lazy" decoding="async">
<svg class="lyon-routes" role="img" aria-label="27 cycling rides in Lyon, reconstructed chronologically from GPS recordings"></svg>
<a class="lyon-attribution" href="https://services.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer" target="_blank" rel="noopener" title="Imagery: Esri, Vantor, Earthstar Geographics, and the GIS User Community">Esri · imagery credits</a>
<script src="projects/assets/lyon/thumbnail.js?v=5" defer></script>
```

<a href="projects/lyon-cycling-map.html" aria-label="Open Lyon, France Cycling Map project" style="position:absolute;inset:0;z-index:3;display:block;"></a>
:::
::: {.project-card-body}
::: {.project-card-heading}
### [Lyon, France Cycling Map](projects/lyon-cycling-map.qmd){.project-title-link}
::: {.project-date}
Summer 2025
:::
:::
...
:::
Cycling routes in Lyon, France, reconstructed from GPS coordinates extracted from GoPro footage and turned into an interactive map.
...
<script src="projects/assets/visual-design-fabrication/thumbnail.js?v=mirrored-screen-1" defer></script>
```
...
::: {.project-card .compact-project-card .honors-preview-card}
::: {.project-card-art .project-card-image .honors-preview-art}
```{=html}
<img src="projects/assets/arduino-mathematical-visualization/rocket-poster.jpg?v=all-leds-3" alt="Close-up of the Wake Tech rocket display and colored LEDs on my Arduino prototype">
<video class="honors-hover-video" muted loop playsinline preload="none" aria-hidden="true" tabindex="-1"><source src="projects/assets/arduino-mathematical-visualization/rocket-preview.mp4?v=clean-2" type="video/mp4"></video>
<script src="projects/assets/arduino-mathematical-visualization/thumbnail.js?v=mobile-lcd-1" defer></script>
<link rel="stylesheet" href="projects/assets/arduino-mathematical-visualization/thumbnail.css?v=rocket-responsive-4">
```
...
:::
Three Wake Tech honors projects using Arduino, programming, and electronics to make abstract mathematical concepts easier to understand through hands-on demonstrations.
...
:::
My 2020 assembly class project, revisited through a browser-based Intel 8085 simulator I built.
...
```{=html}
<script src="projects/assets/cards/mobile-scroll-preview.js?v=1" defer></script>
```
