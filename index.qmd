...
::: {.project-card-art .project-card-image}
```{=html}
<img class="design-tv-thumbnail" src="projects/assets/visual-design-fabrication/tv-front.png" data-still="projects/assets/visual-design-fabrication/tv-front.png" data-animation="projects/assets/visual-design-fabrication/070448729806e4dd.gif" alt="Pixel-art television facing forward with color bars on its screen" loading="lazy" style="width:100%;height:100%;object-fit:contain;image-rendering:pixelated;background:#202c50;">
<script src="projects/assets/visual-design-fabrication/thumbnail.js" defer></script>
```
<a href="projects/visual-design-fabrication.html" aria-label="Open Visual Design and Fabrication project" style="position:absolute;inset:0;z-index:3;display:block;"></a>
:::
::: {.project-card-body}
::: {.project-card-heading}
### [Visual Design & Fabrication](projects/visual-design-fabrication.qmd){.project-title-link}
::: {.project-date}
Spring 2023
:::
:::
...
```
<a href="projects/technical-communication-design.html" aria-label="Open Technical Communication and Design project" style="position:absolute;inset:0;z-index:3;display:block;"></a>
:::
::: {.project-card-body}
::: {.project-card-heading}
### [Technical Communication & Design](projects/technical-communication-design.qmd){.project-title-link}
::: {.project-date}
