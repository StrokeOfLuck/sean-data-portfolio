...
![](projects/assets/game-design-sandbox/schism-poster.jpg){fig-alt="Black-and-white Schism game level ending in a red heart"}
<a href="projects/game-design-sandbox.html" aria-label="Open Game Design Sandbox project" style="position:absolute;inset:0;z-index:3;display:block;"></a>
:::
::: {.project-card-body}
::: {.project-card-heading}
### [Game Design Sandbox](projects/game-design-sandbox.qmd){.project-title-link}
::: {.project-date}
2023–25
:::
:::
...
:::
A playable collaborative puzzle platformer alongside earlier Unity physics experiments that trace my first work with game engines.
