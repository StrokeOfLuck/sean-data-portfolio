...
![](projects/assets/cards/congressional-stock-network-v2.svg){fig-alt="Miniature recreation of the congressional stock trading network interface"}
:::
::: {.project-card-body}
...
![](projects/assets/cards/tankietube-card-restored.svg){fig-alt="Actual TankieTube University of Amsterdam Digital Methods project poster artwork"}
:::
::: {.project-card-body}
::: {.project-card-heading}
### TankieTube
