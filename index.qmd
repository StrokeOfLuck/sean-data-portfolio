...
![](projects/assets/cards/stock-disclosures-actual.webp){fig-alt="Actual rendered Politician Stock Disclosures project page showing the Featured PTR interface"}
:::
::: {.project-card-body}
::: {.project-card-heading}
...
![](https://drive.google.com/thumbnail?id=1kCgZ4PEYHndaUcQFrkFVmwpD9nxYZFCk&sz=w2000){fig-alt="Actual TankieTube University of Amsterdam Digital Methods project poster"}
:::
::: {.project-card-body}
::: {.project-card-heading}
### TankieTube
