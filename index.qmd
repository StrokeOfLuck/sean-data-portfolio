...
<button class="lyon-replay" type="button" aria-label="Replay Lyon route animation">Replay</button>
<script src="projects/assets/lyon/thumbnail.js?v=3" defer></script>
```
