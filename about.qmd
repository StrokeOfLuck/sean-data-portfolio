...
(() => {
  ...
  function detachWord(span,vx=0,vy=0) {
    ...
    floating.className='physics-floating-word';
    floating.textContent=b.text;
    floating.style.font=b.font;
    floating.style.color=b.color;
  ...
  function drawBodies() {
    ...
    for(const b of bodies) {
      ...
      if(b.type==='word') {
        if(b.floatEl) {
          b.floatEl.style.transform =
            `translate3d(${b.x}px,${b.y+cameraShiftY}px,0) translate(-50%,-50%) rotate(${b.angle}rad)`;
        } else {
          ctx.font=b.font;
