...
<div class="page">
  ...
  <section class="intro">
    <div class="copy">
      ...
      <p data-physics-text>My reporting and research draw on political and public datasets, including financial disclosures, government records, online political communication, and transportation data. I use computational methods to answer concrete investigative questions and make public information easier to understand and use.</p>
    </div>
...
<div class="hud">
  ...
  <div class="hud-drive" aria-label="Bike controls">
    ...
    <button id="jump" title="Jump (Space, Up Arrow, or W)">Jump</button>
  </div>
</div>
...
function bodyHitsBike(b) {
  ...
  function keyDown(e) {
    ...
    if(e.code==='Space' || k==='arrowup' || k==='w') { jump(); e.preventDefault(); }
